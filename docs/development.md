# Develop pure3d and build new apps
...
| Goal | Start here |
| --- | --- |
| Add a feature to pure3d | Fork or clone this repository and prepare its shared dependencies, or select its editable project in purefactory when available. |
...
1. Fork [puredesktop/pure3d](https://github.com/puredesktop/pure3d) if you want your own repository, then clone your fork locally. Create a branch for your change.
